...
class App extends Component {
    ...
    _runTest = textToWrite => {
        ...
        NfcManager.registerTagEvent((tag, a) => {
            console.log(tag);
            const url = `${RNFS.DocumentDirectoryPath}`;
            readPath(url).then(a => console.log(a));
        })
                .then(() => {
                    return NfcManager.requestTechnology(NfcTech.Ndef);
                })
